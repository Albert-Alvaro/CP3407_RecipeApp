...
urlpatterns = [
    ...
    path('delete-images/<int:user_id>',views.delete_image,name="delete-images"),
    path('back/<int:user_id>', views.back, name='back'),
    path('del-back/<int:user_id>', views.del_back, name='del_back'),
    path('add_remove_ing/<int:id>/<int:user_id>', views.add_remove_ingredients, name='add_remove_ing'),
